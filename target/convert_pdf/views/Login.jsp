...
<html>
  ...
  <body>
    ...
    <div class="login-container">
      ...
      <form name="loginForm" action="${pageContext.request.contextPath}/Login" method="post" id="loginForm">
      ...
      <% String error = (String) session.getAttribute("error-massage"); if
      (error != null) { %>
      <div class="error-message"><%= error %></div>
      <% session.removeAttribute("error-massage"); } %>

      <div class="login-footer">
        <p>Chưa có tài khoản? <a href="${pageContext.request.contextPath}/views/Register.jsp">Đăng ký</a></p>
    </div>
    </div>
