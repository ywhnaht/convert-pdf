    ...
    <body class="has-header">
                ...
                <form id="filterForm">
                    <div class="filters">
                        ...
                        <div class="filter-group">
                            ...
                            <input type="date" class="filter-input" id="dateFromFilter" name="dateFrom" value="">
                        </div>
                        <div class="filter-group">
        ...
        <script>
            ...
            function updateFileList(files) {
                ...
                <div class="file-item">
                    ...
                    <div class="action-buttons">
                        ${downloadButton}
                        <button class="btn btn-small btn-delete" onclick="deleteFile('${safeFileId}')">
                            🗑️ Xóa
                        </button>
                    </div>
                </div>
                `;
                        ...
                        const errorMessage = error && error.message ? escapeHtml(String(error.message)) : 'Lỗi không xác định';
                        fileListHTML += `
            ...
            async function downloadFile(fileId) {
                ...
                try {
                    showLoading(true);
                    const response = await fetch('downloadFile?file_id=' + encodeURIComponent(fileId), {
                        method: 'GET'
                    });
                    const data = await response.json();
                    if (response.ok) {
            ...
            async function deleteFile(fileId) {
                ...
                try {
                    showLoading(true);
                    const response = await fetch('deleteFile?file_id=' + encodeURIComponent(fileId), {
                        method: 'POST'
                    });
